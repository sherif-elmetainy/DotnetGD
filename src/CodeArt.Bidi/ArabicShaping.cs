...
namespace CodeArt.Bidi
{
    ...
    public class ArabicShaping
    {
        ...
        /// It may be<code>null</code> only if  <code>destSize</code> is 0.</param>
        ...
        /// If<code> destSize</code> is 0, then no output is produced,but the necessary buffer size is returned ("preflighting").  
        /// This does not validate the text against the options, for example,
        ...
        /// If an error occurs, then no output was written, or it may be incomplete.</returns>
        ...
        /// formed or broken.
        /// 'TextDirection' flags control whether the text is read and written
        /// in visual order or in logical order.
        /// 'LettersShape' flags control whether conversion is to or from
        /// presentation forms.
        /// 'Digits' flags control whether digits are shaped, and whether from
        /// European to Arabic-Indic or vice-versa.
        /// 'DigitType' flags control whether standard or extended Arabic-Indic
        ...
        private static readonly bool[] TailFamilyIsolatedFinal =
        {
            /* FEB1 */ true,
            /* FEB2 */ true,
            /* FEB3 */ false,
        ...
        private static readonly bool[] TashkeelMedial =
        {
            /* FE70 */ false,
            /* FE71 */ true,
            /* FE72 */ false,
        ...
        /// <param name="digitBase"></param>
        /// <param name="lastStrongWasAL"></param>
        ...
        /// in case the user specifies the buffer to be <exception cref="ArabicShapingOptions.TextDirectionLogical"></exception>
        /// </summary>
        ...
        /// <summary>
        /// Special Arabic characters need special handling in the shapeUnicode
        ...
        /// <summary>
        /// Returns true for Tashkeel characters else return false
        /// </summary>
        /// <param name="ch"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// returns true if the character is a seen family isolated character in the FE range otherwise returns false
        /// </summary>
        /// <param name="ch"></param>
        /// <returns></returns>
        private static bool IsSeenTailFamilyChar(char ch)
        {
        ...
        /// <summary>
        /// returns true if the character is a seen family character in the Unicode 06 range otherwise returns false
        /// </summary>    
        private static bool IsSeenFamilyChar(char ch)
        {
        ...
        /// <summary>
        ///  returns true if the character matches one of the tail characters (0xfe73 or 0x200b) otherwise returns false
        /// </summary>
        /// <param name="ch"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// returns true if the character is a yehHamza isolated or yehhamza final is found otherwise returns false
        /// </summary>
        /// <param name="ch"></param>
        /// <returns></returns>
        ...
        private static int IsTashkeelOnTatweelChar(char ch)
        {
            ...
            {
                return TashkeelMedial[ch - 0xFE70] ? 1 : 0;
            }
        ...
        /// <param name="ch"></param>
        /// <returns></returns>
        private static bool IsIsolatedTashkeelChar(char ch)
        {
        ...
        /// <summary>
        /// This function calculates the destSize to be used in preflighting when the destSize is equal to 0
        /// </summary>
        ...
        /// <summary>
        /// Counts number of times the subChar appears in the array
        /// </summary>
        /// <param name="dest"></param>
        /// <param name="length"></param>
        ...
        /// <summary>
        /// Shifts characters to replace space sub characters
        /// </summary>
        /// <param name="dest"></param>
        /// <param name="start"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// inverts array, so that start becomes end and vice versa
        /// </summary>
        /// <param name="dest"></param>
        /// <param name="start"></param>
        /// <param name="e"></param>
        ...
        private static int HandleTashkeelWithTatweel(char[] dest, int sourceLength)
        {
            ...
            for (i = 0; i < sourceLength; i++)
            {
                ...
                else if (IsIsolatedTashkeelChar(dest[i]) && dest[i] != ShaddaChar)
                {
                    dest[i] = SpaceChar;
                }
            }
        ...
        /// <param name="start"></param>
        /// <param name="length"></param>
        /// <param name="lacount"></param>
        /// <returns></returns>
        private static bool ExpandCompositCharAtBegin(char[] dest, int start, int length,
            int lacount)
        {
        ...
        /// <param name="start"></param>
        /// <param name="length"></param>
        /// <param name="yehHamzaOption"></param>
        /// <param name="seenTailOption"></param>
        /// <param name="lamAlefOption"></param>
        /// <returns></returns>
            ...
            int yehHamzaOption, int seenTailOption, int lamAlefOption)
        {
            ...
            for (var i = start + length; --i >= start;)
            {
                ...
                else if (seenTailOption == 1 && IsSeenTailFamilyChar(ch))
                {
                    if (i > start && dest[i - 1] == SpaceChar)
                    {
                        dest[i - 1] = _tailChar;
        ...
        /// <summary>
        /// LamAlef needs special handling as the LamAlef is
