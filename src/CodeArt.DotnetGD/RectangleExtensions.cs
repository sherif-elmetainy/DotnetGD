...
namespace CodeArt.DotnetGD
{
    public static class RectangleExtensions
    {
        ...
        public static Rectangle Inflate(this Rectangle rect, int width, int height)
        {
            return new Rectangle(rect.X - width, rect.Y - height, rect.Width + 2 * width, rect.Height + 2 * height);
        }

        public static Rectangle Inflate(this Rectangle rect, Size size)
        {
            return rect.Inflate(size.Width, size.Height);
        }

        public static Rectangle Deflate(this Rectangle rect, int width, int height)
        {
            return rect.Inflate(-width, -height);
        }

        public static Rectangle Deflate(this Rectangle rect, Size size)
        {
            return rect.Inflate(-size.Width, -size.Height);
        }
        ...
        public static Rectangle Offset(this Rectangle rect, Point point)
        {
            return rect.Offset(point.X, point.Y);
        }
